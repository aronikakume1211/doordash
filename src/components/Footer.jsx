...
// import ScootScoot from '../../assets/images/ScootScoot.svg';
                ...
                <div className="footer_container">
                    ...
                    <div className="popular_categories">
                        <ul>
                            ...
                            <li><a href="#">Catering Nearme</a></li>
                    ...
                    <div className="footer_menus_container">
                        ...
                        <div className="footer_download_icons">

                            <a href="https://app.adjust.com/bo0s4gx?engagement_type=fallback_click&amp;tracker_limit=100000">
                                <div className="sc-bb107daa-15 iWbEXY">
                            ...
                            <a
                                href="https://7wmw.adj.st/?adjust_t=9ick0eu&amp;adjust_campaign=CX_US_DR_WB_DS_ACQ_CUSXXX__+FooterWeb&amp;adjust_deeplink=doordash%3A%2F%2F&amp;adjust_fallback=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dcom.dd.doordash&amp;adj_redirect_macos=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dcom.dd.doordash">
                                <div className="sc-bb107daa-15 iWbEXY">
                    ...
                    <div className="footer_bottom">
                        <div className="bottom_left">
                            <svg aria-hidden="true" width="32" height="18" viewBox="0 0 99.5 56.5" fill="#fff">
                                <path
                            ...
                            <a href="#">© 2024 DoorDash</a>
                        </div>
                        <div className="bottom_right">
                            <a href="https://facebook.com/doordash">
                            ...
                            <a href="https://instagram.com/doordash">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true">
