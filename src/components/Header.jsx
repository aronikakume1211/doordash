...
import useIsHomePage from '../utility/isHomepage';
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    return (
        <header className={`${isHomePage ? 'homepage' : 'notHomepage'} ${isSticky ? 'sticky' : ''}`}>
            <div className="header_container">
                <a href='/' className="header_left">
                    <svg aria-hidden="true" width="32" height="18" viewBox="0 0 99.5 56.5" fill="#eb1700ff">
                        <path
                    ...
                    <svg aria-hidden="true" width="112" height="13" viewBox="0 0 361.1 42" fill="#eb1700ff">
                        <path
